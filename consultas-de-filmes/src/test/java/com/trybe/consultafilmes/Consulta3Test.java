...
public class Consulta3Test {
  ...
  @Test
  @DisplayName("Consulta 3 - consulta deve retornar uma lista vazia quando nenhum filme atende ao requisito")
  ...
  public void itensDuplicados() {
    ...
    long contagemCoracaoValente =
        resultados.stream().filter(filme -> filme.equals(Filmes.coracaoValente)).count();
